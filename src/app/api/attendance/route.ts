...
export async function POST(request: Request) {
    try {
        ...
        // studentName이 없으면 GAS 학생 목록에서 실제 studentId로 조회
        // (공용 QR 포함 — sessionStorage가 없거나 초기화된 경우 대비)
        let studentName = (body.studentName as string | undefined)?.trim() || undefined;
